"""Estrategias de alineación avanzadas (familia compleja).

Funciones puras de mayor coste: programación dinámica, componentes
conectados e híbrido (primario).
...
from core.inkcore.extractor_align_basic import MIN_COMP_AREA, align_inkflow
